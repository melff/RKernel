...
- [`WidgetLink$new()`](#method-WidgetLink-initialize)

- [`WidgetLink$clone()`](#method-WidgetLink-clone)
...
[`HasTraits`](https://melff.github.io/RKernel/reference/HasTraits.md)
-\> [`Widget`](https://melff.github.io/RKernel/reference/Widgets.md) -\>
`CoreWidget` -\> `WidgetLink` -\> `DirectionalLink`
...
- [`DirectionalLink$clone()`](#method-DirectionalLink-clone)
...
- [`Widget$send_state()`](https://melff.github.io/RKernel/reference/Widget.html#method-send_state)
- [`Widget$set_state()`](https://melff.github.io/RKernel/reference/Widget.html#method-set_state)
- [`WidgetLink$initialize()`](https://melff.github.io/RKernel/reference/WidgetLink.html#method-initialize)

------------------------------------------------------------------------

### `DirectionalLink$clone()`

The objects of this class are cloneable with this method.

#### Usage

    DirectionalLink$clone(deep = FALSE)
