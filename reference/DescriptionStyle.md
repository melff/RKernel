...
- `DescriptionStyle()`: A Constructor Function for "DescriptionStyle"
  objects
...
- [`DescriptionStyle$clone()`](#method-DescriptionStyle-clone)
...
### `DescriptionStyle$clone()`

The objects of this class are cloneable with this method.

#### Usage

    DescriptionStyle$clone(deep = FALSE)
