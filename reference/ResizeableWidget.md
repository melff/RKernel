...
- [`ResizeableWidget$clone()`](#method-ResizeableWidget-clone)
...
### `ResizeableWidget$clone()`

The objects of this class are cloneable with this method.

#### Usage

    ResizeableWidget$clone(deep = FALSE)
...
-\>
[`AnyWidget`](https://melff.github.io/RKernel/reference/AnyWidget.md)
-\> `ResizeableWidget` -\> `VResizeableWidget`
...
- [`VResizeableWidget$clone()`](#method-VResizeableWidget-clone)
...
### `VResizeableWidget$clone()`

The objects of this class are cloneable with this method.

#### Usage

    VResizeableWidget$clone(deep = FALSE)
...
-\>
[`AnyWidget`](https://melff.github.io/RKernel/reference/AnyWidget.md)
-\> `ResizeableWidget` -\> `HResizeableWidget`
...
- [`HResizeableWidget$clone()`](#method-HResizeableWidget-clone)
...
### `HResizeableWidget$clone()`

The objects of this class are cloneable with this method.

#### Usage

    HResizeableWidget$clone(deep = FALSE)
