...
- [`Button$on_click()`](#method-Button-on_click)

- [`Button$click()`](#method-Button-click)

- [`Button$clone()`](#method-Button-clone)
...
#### Usage
    ...
    Button$on_click(handler, remove = FALSE)
...
- [`ButtonStyle$clone()`](#method-ButtonStyle-clone)
