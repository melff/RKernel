...
"FloatWidgetClass", which in turn have the S3 class attribute
"FloatWidget"
...
-\> `ValueWidget` -\> `FloatWidget`

## Public fields

- `value`:

  A [Float](https://melff.github.io/RKernel/reference/Float.md) traitlet

## Methods

### Public methods

- [`FloatWidget$clone()`](#method-FloatWidget-clone)
