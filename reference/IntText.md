...
The function `IntText` creates objects of the R6 Class "IntTextClass",
which in turn have the S3 class attribute "IntText"
...
- [`IntText$clone()`](#method-IntText-clone)
