...
- [`DatePicker$validate_value()`](#method-DatePicker-validate_value)

- [`DatePicker$validate_min()`](#method-DatePicker-validate_min)

- [`DatePicker$validate_max()`](#method-DatePicker-validate_max)

- [`DatePicker$new()`](#method-DatePicker-initialize)

- [`DatePicker$clone()`](#method-DatePicker-clone)
...
### `DatePicker$validate_value()`

Check wether "value" is within range.

#### Usage

    DatePicker$validate_value(value)
...
### `DatePicker$validate_min()`

Validate the "min" field after assignment.

#### Usage

    DatePicker$validate_min(min)
...
### `DatePicker$validate_max()`

Validate the "max" field after assignment.

#### Usage

    DatePicker$validate_max(max)
